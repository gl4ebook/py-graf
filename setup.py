...
# We use exec here so we don't import pygraf whilst setting up.
VERSION = {}  # type: ignore
with open("pygraf/version.py", "r") as version_file:
    exec(version_file.read(), VERSION)

setup(
    name="pygraf",
    version=VERSION["VERSION"],
    description="An open-source scalable graph learning library.",
    ...
    keywords="pygraf graph machine learning",
    url="",
    author="Scalable Graph Learning for the Enterprise Book Authors",
    author_email="",
    license="",
    ...
    entry_points={"console_scripts": ["pygraf=pygraf.__main__:run"]},
